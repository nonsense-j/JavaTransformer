...
/**
 * Transform that creates compound expressions by swapping operands in equality expressions.
 * This transformation converts "a == b" to "b == a".
 */
public class CompoundExpression5 extends Transform {
    ...
    public String getDescription() {
        return "Creates compound expressions by swapping operands in equality expressions";
    }
}