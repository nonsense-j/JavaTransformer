...
/**
 * Transformation that converts while loops to do-while loops.
 */
public class LoopConversion2 extends Transform {

    private static LoopConversion2 instance = new LoopConversion2();
    ...
    public String getDescription() {
        return "Converts while loops to do-while loops";
    }
}