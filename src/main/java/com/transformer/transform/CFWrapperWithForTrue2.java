...
/**
 * Transform that wraps statements with a for loop that runs from 0 to 1 with break statement.
 * This creates a for loop that executes exactly once with explicit counter.
 */
public class CFWrapperWithForTrue2 extends Transform {
    ...
    public String getDescription() {
        return "Wraps statements with a for loop that runs from 0 to 1 with break statement";
    }
}